 ...
 public static void main(String args[])
{
 ...
 case 2:System.out.println("All Teacher list is :"+Teacher);
  ...
  case 3:System.out.println("Enter Teacher name to delete:");
       ...
       System.out.println("Teacher added successfully");
       break;
  case 4:System.out.println("Enter Teacher name:");
       Sname=sc.next();
      if(Teacher.contains(sname)){
       System.out.println("Teacher is available in list");
    }
      else{
      System.out.println("Teacher name is not found");
    }
       break;
   }
  }
